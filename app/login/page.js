...
const Login = () => {
  ...
  const onSubmit = async (formData) => {
    try {
      ...
      // ✅ Save token from response body (works with httpOnly: false cookie too)
  ...
  return (
    <div className="min-h-screen bg-[#0e0e10] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-[#18181b] rounded-2xl shadow-2xl p-8 border border-[#3d3d3f]">
        ...
        <h2 className="text-2xl font-bold text-white mb-1">Sign in to CodeBox</h2>
        <p className="text-[#adadb8] text-sm mb-7">
          Don't have an account?{' '}
          <a href="/signup" className="text-purple-400 hover:text-purple-300 transition font-medium">Sign up</a>
        </p>
